...
const CustomLaraPreset = definePreset(Aura, {
  primitive: {
      borderRadius: {
          none: "0",
          xs: "2px",
...
export const appConfig: ApplicationConfig = {
  providers: [provideAnimationsAsync(),
    ...
    }),provideZoneChangeDetection({ eventCoalescing: true }), provideRouter(routes), provideClientHydration(), provideFirebaseApp(() => initializeApp({"projectId":"splitwiseclone-49479","appId":"1:103744049747:web:e84a58ed065d00f35aeca6","storageBucket":"splitwiseclone-49479.firebasestorage.app","apiKey":"AIzaSyCno8aNACzquONjWqa2aEBXZqXzZz6E8BU","authDomain":"splitwiseclone-49479.firebaseapp.com","messagingSenderId":"103744049747","measurementId":"G-MR1W4X880F"})), provideAuth(() => getAuth())]
};
